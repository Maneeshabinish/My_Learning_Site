...
class __TwigTemplate_8c3596084b459b549aeb79fb31aa3d48 extends Template
{
    private $source;
    private $macros = [];
...
($context["is_top_level_menu"] ?? null) && twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 129))) ? ("primary-nav-submenu-toggle-button") : (false))]), "html", null, true);
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/navigation/menu--primary-menu.html.twig", "C:\\Users\\91894\\Desktop\\xampp\\htdocs\\MyLearningSite\\web\\core\\themes\\olivero\\templates\\navigation\\menu--primary-menu.html.twig");
    }
